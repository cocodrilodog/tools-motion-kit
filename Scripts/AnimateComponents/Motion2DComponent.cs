namespace CocodriloDog.Animation {
	...
	/// <summary>
	/// Component for <see cref="Vector2"/> motions.
	/// </summary>
	/// 
	/// <remarks>
	/// This is a Motion3DComponent, but overrides the necessary members to adapt it for 2D motions.
	...
	public class Motion2DComponent : MotionBaseComponent<Vector3, Motion3D> {
		...
		public override void Initialize() {
			...
			// HACK: The code in this method is copied from the MotionBaseComponent implementation, 
